...
(Equations \ref{eq: predictive_mean} and \ref{eq: perdictive_variance}), both of which 
...
\cite[p.~79]{rasmussen2006gaussian}

\vspace{1em}
\noindent
In other words, the kernel function enforces how strongly different input values effect each of their outputs
.\cite{rasmussen2006gaussian} divide kernels into two major sub-groups, stationary kernels and non-stationary kernels. 
...
see \cite{duvenaud2014kernel} and \cite[Ch.~4]{rasmussen2006gaussian}.
