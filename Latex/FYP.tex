\documentclass[10pt]{ucdgradtaughtthesis}
\usepackage{multirow}
\usepackage{pdfpages}
...
\begin{figure}[H]
    ...
    \caption[Motivating NR Method Figure]{Contour plots showing the ratio of mismatches with respect to NR simulations, for different effective parallel and perpendicular spin components, averaged over a range of mass ratios. 
