...
In Section~\ref{sec: priortoposterior}, we derived the mean and variance for the posterior distribution (Equations~\ref{eq: predictive_mean} and~\ref{eq: perdictive variance}). 
These quantities depend explicitly on the choice of kernel function, which encodes prior assumptions about the smoothness and structure of the functions we expect.
In this section, we explore different types of kernels and discuss how they affect samples from the posterior distribution.
