...
\end{equation}
where \(\langle\cdot,\cdot\rangle\) is the inner product of both GW, and we maximise over a set of (intrinsic and/or extrinsic) model parameters \(\mathbf{\lambda_m}\) depending on the type of mismatch we wish to compute.
\Sarp{Probably earlier on you need to introduce and list all 15 parameters: 8 intrinsic, 7 extrinsic (Assuming quasicircular orbits}
